...
def construct_boundary_obstacle_aligned_triangulation(scenario: Scenario, axis=0, boundary_margin=20):
    ...
    fairway_network = scenario.waters_network
    fairways = fairway_network.waters
    ...
    lane_rep2 = whole_polygon_setup(lanelet_bounds.lane_hull(fairway_network))
...
def construct_road_polygons(scenario: Scenario, method, kwargs):
    build_func_dict = {
        ...
        #TODO: see updatet version lanelet polyogon with constructor
