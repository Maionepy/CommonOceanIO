...
def create_img_boxes_traffic_lights(
    ...
    scale_factor = commonocean.visualization.draw_dispatch_cr\
        ._retrieve_alternate_value(
            ...
            ('scenario', 'waters_network', 'traffic_light', 'scale_factor'))
    show_label = commonocean.visualization.draw_dispatch_cr\
        ._retrieve_alternate_value(
            draw_params, call_stack, ('traffic_light', 'show_label'),
            ('scenario', 'waters_network', 'traffic_light', 'show_label'))
    zorder = commonocean.visualization.draw_dispatch_cr\
        ._retrieve_alternate_value(
            draw_params, call_stack, ('traffic_light', 'zorder'),
            ('scenario', 'waters_network', 'traffic_light', 'zorder'))
...
def draw_traffic_light_signs(traffic_lights_signs: Union[
    ...
    zorder_0 = commonocean.visualization.draw_dispatch_cr\
        ._retrieve_alternate_value(
            draw_params, call_stack, ('traffic_light', 'zorder'),
            ('scenario', 'waters_network', 'traffic_light', 'zorder'))
