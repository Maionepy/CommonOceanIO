...
class TestObstacle(unittest.TestCase):
    def test_initialize_static_obstacle(self):
        obstacle_id = 100
        obstacle_type = ObstacleType.RESTRICTEDAREAS
    ...
    def test_transform_static_obstacle(self):
        ...
        obstacle = StaticObstacle(obstacle_id=1, obstacle_type=ObstacleType.FISHINGVESSEL, obstacle_shape=Rectangle(4.3, 8.9),
    ...
    def test_transform_dynamic_obstacle(self):
        ...
        dynamic_obs = DynamicObstacle(obstacle_id=30, obstacle_type=ObstacleType.ANCHOREDVESSEL,
    ...
    def test_get_occupancy_static_obstacle(self):
        ...
        rect = Rectangle(5.1, 2.6)
        static_obs = StaticObstacle(obstacle_id=30, obstacle_type=ObstacleType.ANCHOREDVESSEL,
    ...
    def test_get_occupanciy_dynamic_obstacle(self):
        ...
        dynamic_obs = DynamicObstacle(
            obstacle_id=30, obstacle_type=ObstacleType.ANCHOREDVESSEL, initial_state=State(**{'position': np.array(
    ...
    def test_state_at_time(self):
        ...
        dynamic_obs = DynamicObstacle(
            obstacle_id=30, obstacle_type=ObstacleType.MOTORVESSEL, initial_state=initial_state,
