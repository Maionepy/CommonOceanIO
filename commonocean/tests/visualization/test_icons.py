...
from commonocean.scenario.scenario import Scenario, ScenarioID
from commonocean.tests.util import parallel_waters
...
class TestIcons(unittest.TestCase):
    ...
    # Here we can't compare the types yet
    # The DynamicObstacle of commonocean does not contain the correct values of
    # veh_type (provenient of icons.supported_icons()) so we can't check at the moment


    # def test_draw_scenario(self):
    #     """Draw a full scenario with different icons"""
    #     lanelets = parallel_waters(1)
    #     scn = Scenario(0.1, ScenarioID())
    #     scn.waters_network.add_waters(lanelets[0])
    #     shape = Rectangle(5, 2)
