...
import numpy as np
from commonocean.common.solution import StateFields, XMLStateFields, StateType, TrajectoryType, PlanningProblemSolution,\
    Solution, CommonRoadSolutionWriter, CommonRoadSolutionReader, VehicleModel, VehicleType, CostFunction
# Probably CommonOcean instead of CommonRoad in the name of the functions/parameters here?
...
class TestPlanningProblemSolution(unittest.TestCase):
    ...
    def test_planning_problem_solution(self):
        pp_solution = PlanningProblemSolution(
            ...
            vehicle_type=VehicleType.MOTORVESSEL,
        ...
        assert pp_solution.vehicle_type == VehicleType.MOTORVESSEL
...
class TestSolution(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.scenario_id = ScenarioID.from_benchmark_id('USA_US101-33_2_T-1', "2022a")
    ...
    def test_solution_vehicle_ids(self):
        ...
        pp_solution_2 = PlanningProblemSolution(
            ...
            vehicle_type=VehicleType.SAILINGVESSEL,
    ...
    def test_solution_benchmark_id(self):
        ...
        assert solution_single.benchmark_id == 'KS1:JB1:USA_US101-33_2_T-1:2022a'
        assert solution_collab.benchmark_id == '[KS1,ST2]:[JB1,SA1]:USA_US101-33_2_T-1:2022a'
...
class TestCommonRoadSolutionWriter(unittest.TestCase):
    ...
    def test_write_version(self):
        self.solution_single.scenario_id.scenario_version = '2022a' # Here was '2018b' previously
...
class TestCommonRoadSolutionReader(unittest.TestCase):
    ...
    def test_datetime(self):
        self.solution_single.date = datetime.strptime("2022-11-17T01:23:45", '%Y-%m-%dT%H:%M:%S')
        solution_xml_single = DummyDataGenerator.create_solution_xml(self.solution_single)
        parsed_solution_single = CommonRoadSolutionReader.fromstring(solution_xml_single)
        self.assertEqual(datetime(2022, 11, 17, 1, 23, 45), parsed_solution_single.date)
